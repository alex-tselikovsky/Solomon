...
namespace SolomonTests {
    ...
    public class ParseDatas {
        ...
        public void GetFactsTest() {
            ...
            var articleText =
                "Здравствуйте, ранее обращались с просьбой покоса травы в районе детской площадки дома 63 ул. Пушкина. Просим дать поручение о повторном скосе травы в районе газовых труб от детской площадки до сауны\"Батерфляй\", так как покос произведен в на незначительной части территории. Растения достигают в высоту 130 см. Если данная территория не относиться к вашей территории обслуживая, просим дать необходимые указания той организации которая несёт ответственность за содержание данного земельного участка";
