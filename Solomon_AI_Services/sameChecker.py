...
class Checker(object):
    ...
    def find_index_of_similar(self, text, top_n = 5, min_sim=0.8):
        ...
        return [(related_index, cosine_similarities[related_index]) for related_index in related_docs_indices if cosine_similarities[related_index] >= min_sim and cosine_similarities[related_index] < 0.98 ][0:top_n]
